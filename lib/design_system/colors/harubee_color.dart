...
class HarubeeColor {
  static Color mainPrimary(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFF5849E4);
      case Appearance.dark:
        return const Color(0xFF5849DF);
    }
  }
  ...
  static Color mainPrimary30(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x4D4956E4);
      case Appearance.dark:
        return const Color(0x4D5849DF);
    }
  }
  ...
  static Color mainPrimary10(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x1A5849E4);
      case Appearance.dark:
        return const Color(0x265849DF);
    }
  }
  ...
  static Color mainSecondary(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFF898EEB);
      case Appearance.dark:
        return const Color(0xFF5E50D7);
    }
  }
  ...
  static Color mainTertiary60(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x99D6D6FD);
      case Appearance.dark:
        return const Color(0x335144C3);
    }
  }
  ...
  static Color mainTertiary15(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x26D6D6FD);
      case Appearance.dark:
        return const Color(0x33877CE8);
    }
  }
  ...
  static Color mainTertiary10(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x1AD6D6FD);
      case Appearance.dark:
        return const Color(0x1C877CE8);
    }
  }
  ...
  static Color textPrimary30(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x4D21212E);
      case Appearance.dark:
        return const Color(0x59FCFCFC);
    }
  }
  ...
  static Color textPrimary10(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x1A21212E);
      case Appearance.dark:
        return const Color(0x1AFCFCFC);
    }
  }
  ...
  static Color textPrimary5(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x0D21212E);
      case Appearance.dark:
        return const Color(0x0DFCFCFC);
    }
  }
  ...
  static Color textSecondary(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFF9AA5D1);
      case Appearance.dark:
        return const Color(0xFF5D608F);
    }
  }
  ...
  static Color textSecondary40(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x669AA5D1);
      case Appearance.dark:
        return const Color(0x66393B66);
    }
  }
  ...
  static Color textTertiary(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFFC4C2E0);
      case Appearance.dark:
        return const Color(0xFF64666F);
    }
  }
  ...
  static Color textTertiary30(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x4DD6DAEC);
      case Appearance.dark:
        return const Color(0x4D64666F);
    }
  }
  ...
  static Color bgSecondary(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFFF0F0FE);
      case Appearance.dark:
        return const Color(0xFF45428A);
    }
  }
  ...
  static Color bgSecondary50(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x80F0F0FE);
      case Appearance.dark:
        return const Color(0x4D413E85);
    }
  }
  ...
  static Color warning10(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x1AFF5C5C);
      case Appearance.dark:
        return const Color(0x1AD65252);
    }
  }
  ...
  static Color streak(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0x4D5849E4);
      case Appearance.dark:
        return const Color(0xFF5F5CB3);
    }
  }
  ...
  static Color hivePrimaryBack(Appearance mode) {
    switch (mode) {
      case Appearance.light:
        return const Color(0xFFD6DAEC);
      case Appearance.dark:
        return const Color(0x4D7769FF);
    }
  }
